            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewDA"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editDA"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteDA"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Assistant Name</div>
                  <input
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Assistant ID</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Doctor ID</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
...
export default DrAssistantLists;
