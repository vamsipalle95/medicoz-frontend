        ...
        <table className="overflow_tb2 mb-3" id="table_id">
          <thead>
            <tr>
              ...
              <th>Start Date</th>
              <th>Due Date</th>
              <th>Poly-Clinic Package</th>
              <th>Consultant Package</th>
              <th>Clinic Package</th>
              <th>Enable as Remote Partner</th>
              <th>Show as Top Poly-Clinic</th>
            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewPolyClinic"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editPolyClinic"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deletePolyClinic"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Poly-Clinic Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Poly-Clinic Name"
                  />
                </div>
                <div className="col-6">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Poly-Clinic Admin Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Designation</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Poly-Clinic Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Consultant Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Clinic Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Show as Top Poly-Clinic</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
