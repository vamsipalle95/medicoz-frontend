            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewPDS"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editPDS"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deletePDS"
                ></i>
              </td>
            </tr>
            <tr>
          ...
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Pharmacy ID</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                View Pharmacy Delivery Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                Edit Pharmacy Delivery Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                Delete Pharmacy Deliver Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
...
export default PharmacyDeliveryStaffList;
