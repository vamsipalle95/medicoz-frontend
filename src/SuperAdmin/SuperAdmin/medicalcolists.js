        ...
        <table className="overflow_tb2 mb-3" id="table_id">
          <thead>
            <tr>
              ...
              <th>Start Date</th>
              <th>Due Date</th>
              <th>Enable Medical Co. Subscription</th>
            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewMC"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editMC"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteMC"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Medical Co. Name</div>
                  <input
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Medical Co. Admin Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Medical Co. Admin Name"
                  />
                </div>
                <div className="col-6">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Current Package Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Current Package Name"
                  />
                </div>
                <div className="col-6">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">
                    Enable Medical Co. Subscription
                  </div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
          ...
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Cureent Package Name</div>
                  <div>Current Package Name</div>
                </div>
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Start Date</div>
                  <div>07/09/2021</div>
