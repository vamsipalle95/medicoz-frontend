    ...
    <div>
      <div className="container px-2 py-5">
        <div className="draCard2 ms-auto me-auto p-3">
          ...
          {/*doacTitle-ends-here*/}
          <div
            className="d-flex align-items-center w-100 mt-3 pb-3"
            style={{ borderBottom: "1px solid #B5B5B5 !important" }}
          >
            <div className="doaNText">Add new Family Member</div>
            <button
              type="button"
              data-bs-toggle="modal"
              data-bs-target="#addFamilymember"
              className="btn ms-auto doaOrangeBtn"
            >
              + Add
            </button>
          </div>
          ...
          <form className="ogrBtnGroup w-100 mt-3">
            ...
            <div className="w-100 text-end d-flex flex-wrap mt-4">
              <button
                ...
                className="btn doabBtn ms-auto me-3 px-4"
              >
                Back
              </button>
              <Link to="/WhoisCarTaker">
                <button type="submit" className="btn doacBtn px-4">
                  Next
                </button>
              </Link>
            </div>
          ...
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="w-100 d-flex align-items-center mt-3">
                ...
                <div className="w-auto">
                  <div className="doaDuration">
                    <a href="/">
                      Add Photo
                      <img src={Edit} alt="edit" className="ms-2" />
                    </a>
                  </div>
                  <div className="grayTextBox mt-2">Srinivas</div>
              ...
              <form className="w-100 mt-4">
                ...
                />
                <div className="doaNText w-100 mt-4">Select Relationship</div>
                <div className="abFormGroup w-100 mt-3">
                  <input
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option1">
                    Son
                  </label>
                  <input
                    type="radio"
                    ...
                    defaultChecked
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option2">
                    Daughter
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option3">
                    Wife
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option5">
                    Father
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option6">
                    Mother
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option7">
                    Brother
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option8">
                    Sister
                  </label>
                  <input
                    type="radio"
                    ...
                    autoComplete="off"
                  />
                  <label className="btn px-3 py-1 m-1" htmlFor="option9">
                    Relative
                  </label>
                </div>
