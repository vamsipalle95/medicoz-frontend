...
export default function DrsOnlineNowAtClinic() {
  ...
  <div className="irBtn m-2">
    ...
    <div className="form-check form-check-inline">
      <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" defaultValue="option3" defaultChecked />
...
<div className="d-flex flex-wrap align-items-center">
      ...
      <div className="dropdown sortingDD m-2">
        ...
        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          <li><a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#cityTown">By City/Town/Dist</a></li>
          <li><a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#pincode">By Pincode</a></li>
          <li><a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#mandalVillage">By Mandal/Village</a></li>
        </ul>
      </div>
      {/*dropdown-ends-here*/}
    ...
    <div className="d-flex flex-wrap align-items-center justify-content-start">
      ...
      <div className="sdrText1 m-2 d-flex flex-wrap justify-content-start align-items-center">
        Select Clinic & Book Clinic Doctor

        <div className="iconBtn  mt-2 mb-2 ml-5r">
        <button type="button" className="btn" data-bs-toggle="modal" data-bs-target="#Nearby"><img src={Location} alt="loc" className="me-2" />Show Nearby</button>
      </div>
      </div>
      {/*sdrText1-ends-here*/}
    ...
    <div className="d-flex flex-wrap justify-content-center justify-content-sm-start align-items-baseline">
      <div className="drOnlineCard m-2 p-3">
        <div className="text-end w-100 mb-2 drLike">
            ...
            <Link to="/ClinicPublicProfile"><div className="w-100 mb-3 drLogo">
              <img src={Yashoda} alt="yashoda" />
              </div>
            </Link>
            <div className="w-100 mb-1 drName">
              <Link to="/ClinicPublicProfile"><h3 className="mb-0">Clinic name will go here</h3></Link>
            </div>
            ...
            <div className="w-100 text-center dhcBtn">
             <Link to="/BookAppointmentClinicDrList"> <button type="button" className="btn">View Doctors</button></Link>
            </div>
          </div>
