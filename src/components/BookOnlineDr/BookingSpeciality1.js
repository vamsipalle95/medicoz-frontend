...
export default function BookingSpeciality1() {
  ...
  <div className="d-flex flex-wrap align-items-center">
    <div className="input-group searchInput m-2">
      ...
      <input type="search" className="form-control" placeholder="Search Specialities" />
    </div>
    {/*searchbar-ends-here*/}
...
{/*sorting-container-ends-here*/}
  ...
  <div className="d-flex flex-wrap justify-content-center justify-content-md-start align-items-baseline">
    <div className="spgTitle w-100 m-3">
      Select Speciality
    </div>
    {/*spgTitle-ends-here*/}
    <div className="specialityCard p-3 m-3">
      <div className="w-100 d-flex align-items-center mb-2">
        <div className="spCardTitle">
          <Link to="/BookAppointCategory">General physician<br />
            Second line</Link> 
        </div>
    ...
    <div className="specialityCard p-3 m-3">
      <div className="w-100 d-flex align-items-center mb-2">
        <div className="spCardTitle">
          <Link to="/BookAppointCategory2">General physician<br />
            Second line</Link>
        </div>
        {/*spCardTitle-ends-here*/}
        <div className="spCardIcon ms-auto">
    ...
    <div className="specialityCard p-3 m-3">
      <div className="w-100 d-flex align-items-center mb-2">
        <div className="spCardTitle">
          <Link to="/BookAppointmentClinicList">General physician<br />
            Second line</Link>
        </div>
        {/*spCardTitle-ends-here*/} 
        <div className="spCardIcon ms-auto">
