...
export default function BookInPersonAppoinment() {
...
<div className="draCard3 ms-auto me-auto p-3 m-2">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
        <img src={Usergreen} alt="todo" className="me-2" />
        <h3 className="mb-0">Book In-Person Appointment</h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <div className="doaConfirm w-100 d-flex align-items-center mt-4">
        ...
        <button type="button" onClick={ () => { history.push("/LoginOtp4");}}  className="btn doacBtn">Confirm</button>
    </div>
