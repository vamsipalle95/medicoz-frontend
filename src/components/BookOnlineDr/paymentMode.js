...
export default function PaymentMode() {
    ...
    if(auth) {
        ...
        return <Redirect to="/VideoScreen" />
     }
  ...
  <div className="draCard2 ms-auto me-auto p-3">
    ...
    {/*doacTitle-ends-here*/}
    <button Redirect onClick={ () => setAuth(true)} type="button" className="btn spmBtn w-100 mt-4"><img src={Debit} alt="deibit" className="me-3" width="24px" height="24px" />Debit card</button>
