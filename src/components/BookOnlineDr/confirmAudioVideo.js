...
class confirmAudioVideo extends Component {
    render() {
        return (
            <div>
  ...
  <div className="draCard2 ms-auto me-auto p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      ...
      <h3 className="mb-0">Confirm Video/Audio Call</h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <div className="w-100 text-end mt-3">
     <Link to="/PaymentModes"> <button type="submit" className="btn doacBtn">Confirm &amp; Pay</button></Link>
    </div>
  </div>
  {/*draCard1-ends-here*/}
</div>
...
export default confirmAudioVideo;