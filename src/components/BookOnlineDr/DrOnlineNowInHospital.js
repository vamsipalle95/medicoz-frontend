...
export default function DrOnlineNowInHospital() {
    const history = useHistory();
      ...
      <img src={Backbtn} alt="btn" onClick={() => history.goBack()} /><h1 className="sdrText1 me-4">Hosptial Name - ONLINE DR'S NOW</h1>
    </div>
      <div className="drOnlineCard m-2 p-3">
        ...
        <div className="w-100 mb-2 drName">
            <h5 className="fn3"><a href="#">Hospital Name here</a></h5>
