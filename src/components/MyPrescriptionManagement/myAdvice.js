...
export default function MyAdvice() {
  ...
  <div className="draCard2 p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> My Advice’s List</h3>
    </div>
    {/*doacTitle-ends-here*/}
    <form className="w-100 mt-2">
      <div className="w-100 text-end mb-2">
        <a href="#bulkUpload" className="f10mBlue text-decoration-none" data-bs-toggle="modal">Bulk Upload My Advice’s List</a>
      </div>
      <div className="w-100 f10sb mb-2">
        Add
      </div>
      <input className="form-control w-100" type="text" placeholder="Advice" />
      <button type="button" className="btn doaOrangeBtn w-100 mt-3">Add Advice</button>
      <div className="w-100 d-flex flex-wrap align-items-center mt-3" style={{borderBottom: '1px solid #cecece !important'}}>
        ...
        <div className="mb-2">
          <a href><img src={TrashGreen} alt="trashgeen" /></a>
        </div>
      </div>
      {/*flexbox-ends-here*/}
