...
export default function ProvisionalDiagnosis() {
  ...
  <div className="draCard2 p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> My Provisional Diagnosis List</h3>
    </div>
    {/*doacTitle-ends-here*/}
    <form className="w-100 mt-2">
      <div className="w-100 text-end mb-2">
        <a href="#bulkUpload" className="f10mBlue text-decoration-none" data-bs-toggle="modal">Bulk Upload My Provisional Diagnosis List</a>
      </div>
      <div className="w-100 f10sb mb-2">
        Add
      </div>
      <input className="form-control w-100" type="text" placeholder="Provisional Diagnosis" />
      <button type="button" className="btn doaOrangeBtn w-100 mt-3">Add Provisional Diagnosis</button>
