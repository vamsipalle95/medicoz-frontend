            ...
            <div>
                <div className="overflow-auto p-md-3 mb-4">
                            <div className="draCard2 p-3">
                                ...
                                <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> Add Income</h3>
                                </div>
                                {/*doacTitle-ends-here*/}
                                ...
                                <div className="w-100 d-flex flex-wrap align-items-center justify-content-between mt-3 mb-2">
                                    <p className="mpText mb-0">* Income Head</p>
                                    <Link to="/AddIncomeHead" className="f10mBlue text-decoration-none">+ Add Income Head</Link>
                                </div>
                        ...
                        <option value={3}>NetBanking</option>
                                ...
                                <input className="form-control w-100" type="text" required />
                                <button type="submit" className="btn doacBtn d-block mx-auto mt-3 px-4">Save</button>
                                </form>
                                {/*form-ends-here*/}
                            </div>
                            {/*draCard1-ends-here*/}
