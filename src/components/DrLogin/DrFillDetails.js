...
export default function DrFillDetails() {
  return (
    <div>
          ...
          <div className="col-12 col-lg-6 p-3" style={{ height: "100%" }}>
            ...
            >
              ...
              <div className="w-100 mt-4">
                <label className="p18sb">* Dr. Type</label>
                <select className="form-select mt-2">
                  <option selected>Select</option>
                  <option>Allopathy</option>
                  <option>Ayurveda</option>
                  <option>GHomeopathy</option>
                </select>
              </div>
              <div className="w-100 mt-3">
                <label className="p18sb">* Medical Registration Number</label>
                <input
                  type="text"
                  placeholder="1254125"
              ...
              <div className="w-100 mt-3">
                <label className="p18sb">* State Medical Council</label>
                <select className="form-select mt-2">
                  <option selected>Select</option>
                  <option>One</option>
                  <option>Two</option>
              ...
              <div className="w-100 mt-3">
                <label className="p18sb">
                  * Medical Registration Year (YYYY)
                </label>
                <input
                  type="text"
                  placeholder="yyyy"
              ...
              <div className="w-100 mt-3">
                ...
                <input
                  type="file"
                  className="form-control fc-sm mt-2"
                  required
                />
              </div>
              ...
              <div className="w-100 text-center p12 mt-4">
                ...
                <Link to="/DrLogin" className="p12Orange text-decoration-none">
                  Log in
                </Link>
              </div>
            </div>
