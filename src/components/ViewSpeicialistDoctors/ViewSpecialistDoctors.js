...
export default function ViewSpecialistDoctors() {
        ...
        return (
            <div>
                ...
                <div className="w-100 p-3 mpGrayBox">
                   ...
                   <img onClick={() => history.goBack()} src={BackBtn} alt="bktbn" /> Specialist Doctors List - Bulk Appointment Providers
                    </div>
                    {/*doaNText-ends-here*/}
                </div>
            ...
            <div className="d-flex flex-wrap">
                <div className="drOnlineCard1 m-2 p-3" style={{background: '#F1F1F1'}}>
                    ...
                    <div className="w-100 docHospitals border-0 d-flex align-items-center pb-2">
                        <h3 className="mb-0">Hospital Name come here</h3>
                    </div>
                    ...
                    <div className="drOnlineCard2 m-2 p-3" style={{background: '#F1F1F1'}}>
                    <div className="text-end w-100 drLike">
                        <a href="/"><img src={Like} alt="Like" /></a>
                    </div>
                    <div className="text-center w-100 drLogo">
