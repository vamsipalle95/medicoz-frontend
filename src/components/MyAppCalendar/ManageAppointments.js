...
export default function ManageAppointments() {
  ...
  <div className="w-100 p-3 mt-3 mpGrayBox">
    <div className="mpTitle me-3 mb-3 mb-sm-0">
      <img src={Backbtn} alt="backbutto" onClick={() => {history.goBack()}}/> Manage All My Appointment Slots
    </div>
    {/*doaNText-ends-here*/}
  </div>
  {/*flexbox-ends-here*/}
  <div className="w-100 f12sbTeal p-3 mt-3">
    Manage Krupa Clinic (Self Clinic) Slots
  </div>
  <div className="w-100 grayBox mt-3 p-3">
    <div className="w-100 d-flex flex-wrap align-items-center">
      ...
      <div className="orangeDiv d-flex align-items-center mb-3 me-2 p-1">
        <img src={clock} alt="clock" className="me-2" style={{width: 12, height: 12}} />
        <div className="f8mWhite">15 mins</div>
      </div>
      {/*orangeDiv-ends-here*/}
      <div className="mb-3"><a href="#slotDuration" data-bs-toggle="modal" className="text-decoration-none f11sbBlue">Edit</a></div>
    </div>
    {/*flexbox-ends-here*/}
    <div className="w-100 d-flex flex-wrap align-items-center">
      <div className="f10m w-md-40 mb-3 me-2">Select Patient Consultation Modes</div>
      <div className="orangeDiv d-flex align-items-center mb-3 me-2 p-1">
        <img src={PersonWhite} alt="personWhite" className="me-2" style={{width: 12, height: 12}} />
        <div className="f8mWhite">In-Person On - <span style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>₹</span> 300</div>
      </div>
      {/*orangeDiv-ends-here*/}
      <div className="hashDiv d-flex align-items-center mb-3 me-2 p-1">
        <img src={CamcorderWhite} alt="camcorder" className="me-2" style={{width: 12, height: 12}} />
        <div className="f8mWhite">Video Off - <span style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>₹</span> 500</div>
      </div>
      {/*hashDiv-ends-here*/}
      <div className="hashDiv d-flex align-items-center mb-3 me-2 p-1">
        <img src={PhoneWt} alt="phen" className="me-2" style={{width: 12, height: 12}} />
        <div className="f8mWhite">Audio Off - <span style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>₹</span> 300</div>
      </div>
      {/*hashDiv-ends-here*/}
      <div className="mb-3"><a href="#pcmc" className="text-decoration-none f11sbBlue" data-bs-toggle="modal">Edit</a></div>
    </div>
    {/*flexbox-ends-here*/}
    <div className="w-100 d-flex flex-wrap align-items-center">
      <div className="f10m w-md-40 mb-3 me-2">Select Medical Rep Appointment Modes</div>
      <div className="hashDiv d-flex align-items-center mb-3 me-2 p-1">
        <img src={CamcorderWhite} alt="camcorder" className="me-2" style={{width: 12, height: 12}} />
      ...
      {/*orangeDiv-ends-here*/}
      <div className="mb-3"><a href="#mrcm" className="text-decoration-none f11sbBlue" data-bs-toggle="modal">Edit</a></div>
    </div>
    {/*flexbox-ends-here*/}    
  </div>
  {/*grayBox-ends-here*/}
  <div className="w-100 d-flex align-items-center mt-4">
    <button type="button" className="btn btn-sm pnBtn me-4"><i className="bi bi-chevron-left" /></button>
    <div className="doaSchedule d-flex align-items-center overflow-auto">
      <div className="pb-1 me-4 active">
        Apr-2021
      </div>
      <div className="pb-1 me-4">
        May-2021
      </div>
      <div className="pb-1 me-4">
        June-2021
  ...
  <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
    <div className="draCard2 p-3 m-2">
      <div className="w-100 doacTitle d-flex justify-content-between align-items-center pb-2">
        <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> Patient Slots</h3>
        <a href="#cpmr" className="text-decoration-none f11sbBlue" data-bs-toggle="modal">Cancel Slots</a>
      </div>
      {/*doacTitle-ends-here*/}
      <div className="w-100 d-flex flex-wrap align-items-center mt-2">
        <div className="divWhite f8m m-2 p-1">
          Apr 4 to Apr 13
        </div>
        {/*divWhite-ends-here*/}
        <div className="divWhite f8m m-2 p-1">
      ...
      {/*flexbox-ends-here*/}
      <div className="mpText w-100 mt-2 pb-2" style={{borderBottom: '1px solid #B5B5B5 !important'}}>From 5:00 AM to 10:00 PM</div>
      <button type="button" className="btn doaOrangeBtn d-block mt-3 mx-auto" data-bs-toggle="modal" data-bs-target="#addEditSlot">+Add New Time Slot</button>
    </div>
    {/*draCard1-ends-here*/}
    <div className="draCard2 p-3 m-2">
      <div className="w-100 doacTitle d-flex justify-content-between align-items-center pb-2">
        <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> Medical Rep Slots</h3>
        <a href="#cpmr" className="text-decoration-none f11sbBlue" data-bs-toggle="modal">Cancel Slots</a>
      </div>
      {/*doacTitle-ends-here*/}
      <div className="w-100 d-flex flex-wrap align-items-center mt-2">
      ...
      {/*flexbox-ends-here*/}
      <div className="mpText w-100 mt-2 pb-2" style={{borderBottom: '1px solid #B5B5B5 !important'}}>From 9:00 PM to 10:00 PM</div>
      <button type="button" data-bs-toggle="modal" data-bs-target="#MedicalReps" className="btn doaOrangeBtn d-block mt-3 mx-auto">+Add New Time Slot</button>
    </div>
    {/*draCard1-ends-here*/}
  </div>
  {/*flexbox-ends-here*/}
          ...
          <div className="w-100 d-flex flex-wrap">
            ...
            <div className="mb-2">
              ...
              <div className="d-flex flex-wrap align-items-center mx-auto mt-2">
                ...
                <input className="form-control w-50" type="text" placeholder={500} />
              </div>
              {/*flexbox-ends-here*/}
              <div className="w-100 d-flex flex-wrap align-items-center mt-2">
                <div className="me-2">
                ...
                <input className="form-control w-50" type="text" placeholder={400} />
              </div>
              {/*flexbox-ends-here*/}
              <div className="w-100 d-flex flex-wrap align-items-center mt-2">
                <div className="me-2">
                ...
                <input className="form-control w-50" type="text" placeholder={600} />
              </div>
              {/*flexbox-ends-here*/}
            </div>
            ...
            <div className="mb-2">
              ...
              <div className="w-100 d-flex flex-wrap align-items-center mt-1">
                ...
                <input className="form-control w-50" type="text" placeholder="1" />
              </div>
            ...
            <div className="mb-2">
              <div className="w-100 doaNText">Consultation Valid for No of Days</div>
              <div className="d-flex flex-wrap align-items-center mx-auto mt-2">
                <div className="me-2">
                  
                </div>
                <input className="form-control w-50" type="text" placeholder="7 Days" />
              </div>
        ...
        <div className="modal-body">
          <form className="w-100">
            ...
            <div className="w-100 d-flex flex-wrap align-items-center mt-3">
              ...
              <button type="button" className="btn doacBtn mb-2" data-bs-dismiss="modal">Cancel Selected Day(s)</button>
            </div>
            {/*flexbox-ends-here*/}
          </form>
          {/*form-ends-here*/}
