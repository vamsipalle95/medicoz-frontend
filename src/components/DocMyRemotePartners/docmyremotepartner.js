...
export default function ManageAppointments() {
  ...
  {/*flexbox-ends-here*/}
  <div className="w-100 grayBox d-flex flex-wrap align-items-center justify-content-start mt-3 p-3">
  ...
  <div className="w-100 d-flex flex-wrap align-items-center justify-content-between px-3 mt-3">
    <div className="f12sbTeal me-3 my-2">Manage Slots of "My Remote Partners" </div>
    <button type="button" data-bs-toggle="modal" data-bs-target="#invite" className="btn doaOrangeBtn my-2">Invite Remote Partner</button>
  </div>
