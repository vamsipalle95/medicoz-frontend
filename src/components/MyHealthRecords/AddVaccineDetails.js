      ...
      <div className="overflow-auto p-md-3 mb-4">
        <div className="draCard2 p-3">
          ...
          <form className="w-100 mt-4">
            <div className="doaNText w-100 mb-2">* Vaccine Name</div>
            <input className="form-control w-100" type="text" required />
            <div className="doaNText w-100 mt-3 mb-2">*Dose Number</div>
            <input className="form-control w-100" type="text" required />
            <div className="doaNText w-100 mt-3 mb-2">* Date Taken</div>
            <input className="form-control w-100" type="text" required />

            <div className="doaNText w-100 mt-3 mb-2">* Place Taken at</div>
            <input className="form-control w-100" type="text" required />

            <div className="doaNText w-100 mt-3 mb-2">* Beneficiary ID</div>
            <input className="form-control w-100" type="text" required />

            <div className="doaNText w-100 mt-3 mb-2">* Next Due Date</div>
            <input className="form-control w-100" type="text" required />
