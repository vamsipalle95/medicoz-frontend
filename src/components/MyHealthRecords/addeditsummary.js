...
export default function Addeditsummary() {
  ...
  <div className="draCard2 p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      <h3 className="mb-0"><img onClick={() => history.goBack()} src={Backbt} alt="backbutn" /> Add/Edit Hospital Discharge Summary
      </h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <form className="w-100 mt-4">
      ...
      <button type="submit" className="d-block btn doacBtn px-2 mt-4 mx-auto">Upload Hospital Discharge Summary</button>
    </form>
    {/*form-ends-here*/}
  </div>
  {/*draCard1-ends-here*/}
...
<div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><img src={HeightGreen} alt="heightGreen" className="me-2" />Height</h5>
  ...
  <div className="modal fade" id="weight" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><img src={WeightGreen} alt="wtGreen" className="me-2" />Weight</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          <form>
  ...
  <div className="modal fade" id="bg" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><img src={BloodGroupGreen} alt="bloodgreoup" className="me-2" />Blood Group</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          <form>
  ...
  <div className="modal fade" id="gender" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><img src={GenderGreen} alt="genderGreen" className="me-2" />Gender</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
  ...
  <div className="modal fade" id="age" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><img src={AgeGreen} alt="green"  className="me-2" />Age</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          <form>
  ...
  <div className="modal fade" id="hc" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title" id="filterModalLabel"><i className="bi bi-chevron-left me-2" />Add/Edit Healt=""h Conditions</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          ...
          <form className="form d-flex flex-wrap align-items-flex-start mt-3">
            ...
            <div className="w-100 d-flex align-items-center">
              ...
              <button type="button" className="btn btn-sm ms-2 w-25 doaOrangeBtn">+ Add</button>
            </div>
            {/*flexbox-ends-here*/}
            ...
            {/*flexbox-ends-here*/}
            <div className="doaNText w-100 mt-4 mb-3">Social History &amp; Habits</div>
            <div className="form-check w-50">
              <input className="form-check-input" type="checkbox" defaultValue id="option7" />
              <label className="form-check-label" htmlFor="option7">
                Smoking
              </label>
            </div>
            <div className="form-check w-50">
              <input className="form-check-input" type="checkbox" defaultValue id="option8" />
              <label className="form-check-label" htmlFor="option8">
                Alcohol drinking
              </label>
            </div>
            <div className="form-check w-50 mt-2">
              <input className="form-check-input" type="checkbox" defaultValue id="option9" />
              <label className="form-check-label" htmlFor="option9">
                Pan Masala
              </label>
            </div>
            <div className="form-check w-50 mt-2">
              <input className="form-check-input" type="checkbox" defaultValue id="option10" />
              <label className="form-check-label" htmlFor="option10">
                Tobacco
              </label>
            </div>
            <div className="form-check w-50 mt-2">
              <input className="form-check-input" type="checkbox" defaultValue id="option11" />
        ...
        {/*modal-body-ends-here*/}
        <div className="modal-footer border-0">
          <button type="submit" className="btn fmaBtn mx-auto">Save Healt=""h Concerns</button>
        </div>
        {/*modal-footer-ends-here*/}
      </div>
    </div>
