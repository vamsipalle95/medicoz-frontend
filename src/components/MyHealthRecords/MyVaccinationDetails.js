          ...
          <div className="mpCard p-3 m-2">
            ...
            <div className="w-100">
              <p className="mpText mb-1">
                <span className="clrOrg">Vaccine Name : </span>
                <span> Covisheild</span>
              </p>

              <p className="mpText mb-1">
                <span className="clrOrg">Dose Number :</span> <span> 1</span>
              </p>

              <p className="mpText mb-1">
                <span className="clrOrg">Date taken :</span>
                <span> 03/09/2021</span>
              </p>

              <p className="mpText mb-1">
                <span className="clrOrg">Place Taken at :</span>
                <span> Malakpet Hospital </span>
              </p>

              <p className="mpText mb-1">
                <span className="clrOrg">Beneficiary ID : </span>{" "}
                <span>Cov125451 </span>
              </p>

              <p className="mpText mb-1">
                <span className="clrOrg">Next Due Date : </span>
...
export default MyVaccinationDetails;
