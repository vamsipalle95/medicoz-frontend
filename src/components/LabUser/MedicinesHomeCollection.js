                  ...
                  <div>
                    ...
                    <div className="form-check mt-3">
                      <input
                        ...
                        name="options"
                        id="option1"
                        onclick="location.href='pharma-landing-select-delivery-mode-1.html';"
                      />
                    ...
                    <ul>
                      <li className="f10m mt-3">CBP</li>
                      <li className="f10m mt-2">TFL</li>
                      <li className="f10m mt-2">LFT</li>
                    </ul>
