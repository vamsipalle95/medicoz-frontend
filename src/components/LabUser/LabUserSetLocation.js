                  ...
                  <div className="w-100 d-flex flex-wrap align-items-start mt-4">
                    <div className="draCard2 p-3 m-2">
                      ...
                      <div className="w-100 doaNText d-flex align-items-center mt-3">
                        <Link to="/LabUserDeliveryAddress">
                          {" "}
                          <img
                            src={LocationSmGreen}
                            alt="location"
                      ...
                      <div className="w-100 mpText mt-2">
                        B49, Prakash Nagar,Hyderabad, water tank,Telangana -
                        500016 Mobile: 98483 12345
                      </div>
                      <div className="w-100 mt-3">
                      ...
                      <div className="w-100 mt-4 text-center">
                        <Link to="/LabUserDeliveryAddress">
                          <button
                            type="button"
                            className="btn doacBtn py-1 px-3"
                          >
                            Confirm Location
                          </button>
                        </Link>
                    ...
                    >
                      <div className="mpText">
                        Home Sample Collection within 3 KM FREE
                      </div>
                      <div className="mpText mt-2">
                        Home Sample Collection within 8Km: ₹50/-
                      </div>
                      <div className="mpText mt-2">
                        Minimum order amount for home Sample Collection: ₹300/-
                      </div>
                    </div>
                    {/*card-ends-here*/}
                  </div>
