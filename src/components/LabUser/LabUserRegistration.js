...
function LabUserRegistration() {
  ...
  const handleGreg = () => {
    history.push("/SelectPaymentMode");
  };
  return (
    <div>
          ...
          <div className="col-12 col-lg-6 p-3" style={{ height: "100%" }}>
            ...
            >
              ...
              <div className="w-100 mt-4">
                <label className="p18sb">* Pharmacy Name</label>
                <input type="text" className="form-control mt-2" required />
              </div>
              <div className="w-100 mt-3">
                <label className="p18sb">* Pharmacy Registration Number</label>
                <input type="text" className="form-control mt-2" required />
              </div>
              <div className="w-100 mt-3">
                <label className="p18sb">
                  * Upload Pharmacy Registration Certificate
                </label>
                <input
                  type="file"
