...
export default function ClinicPubliProfile() {
    const history = useHistory(true);
        return (
            <div>
                <div className="container bg-white my-4" style={{border: '1px solid #EAEAEA', borderRadius: '8px !important', maxWidth: '1000px !important'}}>
 <div className="myPhoneCardCnt03 px-5 py-2 w-80 mx-auto">
  <div className="w-100 d-flex flex-wrap align-items-center mt-4">
    ...
    <div className="w-100 d-flex flex-wrap align-items-baseline p-3 p-md-0">
      <img src={Backbtn} alt="btn" onClick={() => history.goBack()} /><h1 className="mpTitle18 me-4">Clinic Name - Profile</h1>
    </div>

  
    <div className="mpText mb-2">
      <img src={LocGreen} alt="locgm" className="me-2" />Begumpet, Hyderabad
    </div>
  </div>
  {/*flexbox-ends-here*/}
  <div className="row">
      ...
      <div className="w-100 tabsOrange">
        <nav>
          <div className="nav nav-tabs border-0" id="nav-tab" role="tablist">
            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#ah" type="button" role="tab" aria-selected="true">About Clinic</button>
            <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#ood" type="button" role="tab" aria-selected="true">Our OPD Doctors</button>
          </div>
        </nav>
        <div className="tab-content" id="nav-tabContent">
            ...
            <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
              <div className="draCard1 p-3 m-2">
                <div className="w-100 doacTitle pb-2">
                  <h3 className="mb-0">Clinic Details</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <a href="#" className="w-100 d-block text-decoration-none f12sbOrange mt-3">Clinic  name</a>
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
                    Renevo Clinic<br />
                    Clinic Registration No: 12345 6789
                  </div>
                </div>
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
              ...
              <div className="draCard1 p-3 m-2">
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  <h3 className="mb-0">Clinic Certificate</h3>
                </div>
                {/*doacTitle-ends-here*/}
              ...
              <div className="draCard1 p-3 m-2">
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  <h3 className="mb-0">Clinic Address</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <div className="w-100 mt-3">
                ...
                <div className="w-100 mpText mt-2">
                  A49, First Floor, IndianAirlines Colony,Begumpet, Hyderabad - 13
                </div>
              </div>
              {/*draCard1-ends-here*/}
              <div className="draCard1 p-3 m-2">
              ...
              <div className="draCard1 p-3 m-2">
                ...
                {/*doacTitle-ends-here*/}
                <div className="w-100 pt-3 pb-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
              ...
              <div className="draCard1 p-3 m-2">
                <div className="w-100 doacTitle pb-2">
                  <h3 className="mb-0"><img src={Badge} alt="badge" className="me-2" />Achievements &amp; Awards</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
                    <img src={OrangeShield} alt="shield" className="me-2" />Award or achievement goes here
                  </div>
                </div>
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
              ...
              <div className="draCard1 p-3 m-2">
                ...
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
                    <img src={FBornage} alt="fb" className="me-2" />facebook.com/venu-prisup
                  </div>
                </div>
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
                    <img src={TwitterOrange} alt="twitter" className="me-2" />twitter.com/venu123
                  </div>
                </div>
                <div className="w-100 py-2" style={{borderBottom: '1px solid #D4D5D5 !important'}}>
                  <div className="mpText mt-1">
                    <img src={LinkedIn} alt="linked" className="me-2" />Linkedin.com/profile/ven…
                  </div>
                </div>
              </div>
              {/*draCard1-ends-here*/}
          ...
          {/*tabpane-1-ends-here*/}
          <div className="tab-pane fade show active" id="ood" role="tabpanel">
            <div className="w-100 d-flex flex-wrap align-items-center">
              <div className="mpText me-3 mt-4">View by Speciality</div>
              <select className="form-select mt-4" style={{width: 200}}>
              ...
              <table id="table_id">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Dr.Kulkarn</td>
                    <td className="text-nowrap"><img src={EllipseGreen} alt="ellipsegreen" className="me-2" />DR.IN</td>
                    <td>2.00PM-4.00PM</td>
                    <td><Link to="/BookAppointmentHospDr" className="text-decoration-none" style={{color: '#F98F45 !important'}}>Book Appointment</Link></td>
                  </tr>
                  <tr>
                    <td>General Physician</td>
                    <td>Dr.Vijay Kumar</td>
                    <td className="text-nowrap"><img src={EllipseRed} alt="ellipsegreen" className="me-2" />DR.OUT</td>
                    <td>2.00PM-4.00PM</td>
                    <td><Link to="/BookAppointmentHospDr" className="text-decoration-none" style={{color: '#F98F45 !important'}}>Book Appointment</Link></td>
                  </tr>
                  <tr>
