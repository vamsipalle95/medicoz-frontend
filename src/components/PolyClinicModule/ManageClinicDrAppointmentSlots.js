...
function ManageClinicDrAppointmentSlots() {
      ...
      <div className="overflow-auto p-md-3 ms-lg-3 mb-4">
        <div className="w-100 p-3 mt-3 mpGrayBox">
          <div className="mpTitle me-3 mb-3 mb-sm-0">
            ...
            />{" "}
            Manage Clinic Doctor Appointment Slots
          </div>
          {/*doaNText-ends-here*/}
        </div>
        {/*flexbox-ends-here*/}
        <div className="w-100 f12sbTeal p-3 mt-3">
          Dr. Venkateshwar Rao - Slots
        </div>
          ...
          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content border-0">
              <div className="modal-header">
                <h5 className="modal-title">
                  <img src={clocksm} alt="clocksm" className="me-2" />
                  Sai Clinic <span className="f10sbTeal">(Specific Slots)</span>
                </h5>
                <button
                  type="button"
                  className="btn-close"
...
export default ManageClinicDrAppointmentSlots;
