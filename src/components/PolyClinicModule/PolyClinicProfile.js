    ...
    <div>
      <div className="overflow-auto p-md-3  mb-4">
        <div className="w-100 d-flex flex-wrap align-items-baseline justify-content-between p-3 p-md-0">
          <div className="mb-2">
            <h1 className="mpTitle mb-0 me-3">Balaji Poly-Clinic (Admin)</h1>
          </div>
        ...
        <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                ...
                <h3 className="mb-0">Poly-Clinic Admin Info</h3>
              </div>
              {/*doacTitle-ends-here*/}
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                <h3 className="mb-0">Poly-Clinic Profile Picture</h3>
              </div>
              {/*doacTitle-ends-here*/}
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                ...
                <h3 className="mb-0">Poly-Clinic Details</h3>
              </div>
              {/*doacTitle-ends-here*/}
              <div
              ...
              >
                ...
                <div className="mpText mt-1">Renevo Clinic</div>
              </div>
              <div
                className="w-100 pt-2 pb-2"
                style={{ borderBottom: "1px solid #D4D5D5 !important" }}
              >
                <div className="doaNText">Poly-Clinic Registration No.</div>
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                ...
                <h3 className="mb-0">Poly-Clinic Certificate</h3>
              </div>
              {/*doacTitle-ends-here*/}
              <div className="w-100 mt-3">
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                <h3 className="mb-0">Poly-Clinic Address</h3>
              </div>
              {/*doacTitle-ends-here*/}
              <div className="w-100 mt-3">
      ...
      <div>
        ...
        >
          <div className="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content border-0">
              ...
              <div className="modal-body">
                <form className="w-100">
                  <div className="mpText w-100 mb-2">* Poly-Clinic Name</div>
                  <input className="form-control w-100" type="text" required />
        ...
        {/*modal-addPoly-Clinic-ends-here*/}
        <div
          className="modal fade show"
          id="addHT"
          tabIndex={-1}
