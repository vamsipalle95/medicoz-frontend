...
import DrAppointmentList from "../PolyClinicModule/DrAppointmentList";
import PolyClinicAppointments from "../PolyClinicModule/PolyClinicAppointments";
import PolyClinicProfile from "../PolyClinicModule/PolyClinicProfile";
...
import ClinicDoctorAppointments from "../PolyClinicModule/ClinicDoctorAppointments";
import ManageClinicDrAppointmentSlots from "../PolyClinicModule/ManageClinicDrAppointmentSlots";
...
import DrRoomRP from "../PolyClinicModule/DrRoomRP";
            ...
            <div className="col-lg-9 col-xs-12 col-sm-12 col100">
              <div className="myPhoneCardCnt overflow-auto p-md-3 my-4">
                <Switch>
                  ...
                  <Route exact path="/ClinicDoctorAppointments">
                    <ClinicDoctorAppointments />
                  </Route>
                  <Route exact path="/HospitalPartners">
                    <HospitalPartners />
                  </Route>

                  <Route exact path="/ManageClinicDrAppointmentSlots">
                    <ManageClinicDrAppointmentSlots />
                  </Route>
                  ...
                  <Route exact path="/PolyClinicAppointments">
                  ...
                  <Route exact path="/PolyClinicProfile">
                    <PolyClinicProfile />
                  </Route>
