...
export default function PtTestQueries() {
            ...
            <div>
                    ...
                    <nav>
                      <div className="nav nav-tabs border-0" id="nav-tab" role="tablist">
                        <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#tab1" type="button" role="tab" aria-selected="true">Patient Follow-up Queries</button>
                        <button className="nav-link" data-bs-toggle="tab" data-bs-target="#tab2" type="button" role="tab" aria-selected="false">RP Follow-up Queries</button>
                        <button className="nav-link" data-bs-toggle="tab" data-bs-target="#tab3" type="button" role="tab" aria-selected="false">Dr.Reply's</button>
                      </div>
                    </nav>
                            ...
                            <table id="table_id" className="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PtDetails">Vinod Kumar</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td>09/08/2021 10:00am</td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PtDetails">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Details & Test Reports</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Text Query</a></td>
                                      </tr>
                                      <tr>
                            ...
                            <table id="table_id" className="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <td>1</td>
                                            <td>09/08/2021 10:00am</td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#RpDetails">Narsimha</a></td>
                                            <td> <a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Vinod Kumar</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                    </tr>
                                    <tr>
                                     ...
                                     <td>2</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#RpDetails">Yashoda Clinic</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
                                      ...
                                      <td>3</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#RpDetails">Life Hospital</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                       <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
                                      ...
                                      <td>6</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#RpDetails">Keerthi Hospital</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
                            ...
                            <table id="table_id" className="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <td>1</td>
                                            <td>09/08/2021 10:00am</td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Narsimha</a></td>
                                            <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PatientDetails">Vinod Kumar</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                    </tr>
                                    <tr>
                                     ...
                                     <td>2</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Yashoda Clinic</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PatientDetails">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
                                      ...
                                      <td>3</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Life Hospital</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PatientDetails">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                       <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
                                      ...
                                      <td>6</td>
                                      <td>09/08/2021 10:00am</td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup2">Keerthi Hospital</a></td>
                                      <td> <a href="#" data-bs-toggle="modal" data-bs-target="#PatientDetails">Vinod Kumar</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup3">Details & Test Reports</a></td>
                                      <td><a href="#" data-bs-toggle="modal" data-bs-target="#Popup4">Text Query</a></td>
                                      </tr>
  ...
  {/*modal-patientProfile-starts-here*/}
  <div className="modal fade" id="RpDetails" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title"><img src={Person} alt="persom" className="me-2" />RP Details</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          <div className="w-100 d-flex align-items-center py-2" style={{borderBottom: '1px solid #B5B5B5'}}>
  ...
  <div className="modal fade" id="PtDetails" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title"><img src={Person} alt="persom" className="me-2" />Patient Details</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
        </div>
        <div className="modal-body">
          <div className="w-100 d-flex align-items-center py-2" style={{borderBottom: '1px solid #B5B5B5'}}>
  ...
  <div className="modal fade" id="PatientDetails" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
          <h5 className="modal-title"><img src={Person} alt="persom" className="me-2" />Patient Details</h5>
  ...
  <div className="modal fade" id="popup3" tabIndex={-1} aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content border-0">
        <div className="modal-header">
...
<div className="modal fade" id="popup4" tabIndex={-1} aria-hidden="true">
  <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div className="modal-content border-0">
      <div className="modal-header">
