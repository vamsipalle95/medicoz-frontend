...
export default function BookSlot() {
        ...
        return (
            <div>
                 <div className="draCard3 m-2 p-3">
                                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                                    <img src={ToDo} alt="todo" className="me-2" />
                                    <h3 className="mb-0">Pt.Appointment Booking by RP</h3>
                                </div>
                                {/*doacTitle-ends-here*/}
                    ...
                    <div className="w-100 doaTabs mt-3">
                        ...
                        <form className="mt-3">
                            ...
                            <span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">9:00 AM </span>
                            </label>
                            <input type="radio" className="btn-check" name="options" id="time2" autoComplete="off" />
                            <label className="btn" htmlFor="time2"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">9:15 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time3" autoComplete="off" />
                            <label className="btn" htmlFor="time3"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">9:30 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time4" autoComplete="off" />
                            <label className="btn" htmlFor="time4"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">9:45 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time5" autoComplete="off" />
                            <label className="btn" htmlFor="time5"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">10:00 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time6" autoComplete="off" />
                            <label className="btn" htmlFor="time6"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">10:15 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time7" autoComplete="off" />
                            <label className="btn" htmlFor="time7"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">10:30 AM </span></label>
                            <input type="radio" className="btn-check" name="options" id="time8" autoComplete="off" />
                            <label className="btn" htmlFor="time8"><span className="cls_block tkn-txt">Token-1</span>
                                <span className="cls_block">10:45 AM </span></label>
                        </form>
                    ...
                    <div className="doaConfirm w-100 d-flex align-items-center mt-4">
                        ...
                        <Link to="/SelectThePatient"><button type="button" className="btn doacBtn">Confirm</button></Link>
                    </div>
