...
export default function BookAppointments() {
    ...
    const history = useHistory();
        ...
        return (
            <div>
                <div className="w-100 doacTitle1 d-flex align-items-center pb-2"><img onClick={() => history.goBack()} src={Backbt} alt="backbtn"/> Book Appointments</div>

                <div class="d-flex flex-wrap">
               <div className="draCard3 p-3 m-2">
                    <div className="w-100 doacTitle d-flex align-items-center pb-2">
                        <img src={ToDo} alt="todo" className="me-2" />
                        <h3 className="mb-0">Book Audio/In-person Appointment</h3>
                    </div>
                    {/*doacTitle-ends-here*/}
                    ...
                    <div className="doaConfirm w-100 d-flex align-items-center mt-4">
                        <button type="button" className="btn doabBtn ms-auto me-3">Back</button>
                        <Link to="/NewOTP"><button type="button" className="btn doacBtn">Confirm</button></Link>
                    </div>
                    ...
                    <div className="draCard3 m-2 p-3">
                        <div className="w-100 doacTitle d-flex align-items-center pb-2">
                            <img src={ToDo} alt="todo" className="me-2" />
                            <h3 className="mb-0">Book Video Appointment</h3>
                        </div>
                        {/*doacTitle-ends-here*/}
                            <div className="w-100 doaInfo d-flex align-items-center mt-3 p-3">
                                <div className="doaProfile me-4">
