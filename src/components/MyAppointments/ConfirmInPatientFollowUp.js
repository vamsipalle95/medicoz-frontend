...
export default function ConfirmAInPatientFollowUp() {
  ...
  <div className="draCard3 ms-auto me-auto p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      <img src={Camcorder} alt="cam" className="me-2" />
      <h3 className="mb-0">Confirm Follow-up In-Patient Appointment</h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <div className="w-100 text-end mt-3">
     <Link to="/PaymentsInPatient"> <button type="submit" className="btn doacBtn">Confirm &amp; Pay</button></Link>
    </div>
  </div>
  {/*draCard1-ends-here*/}
</div>
