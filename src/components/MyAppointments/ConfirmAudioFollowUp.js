...
export default function ConfirmAudioFollowUp() {
  ...
  <div className="draCard3 ms-auto me-auto p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      ...
      <h3 className="mb-0">Confirm Follow-up Audio Appointment</h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <div className="w-100 text-end mt-3">
     <Link to="/PaymentAudio"> <button type="submit" className="btn doacBtn">Confirm &amp; Pay</button></Link>
    </div>
  </div>
  {/*draCard1-ends-here*/}
</div>
