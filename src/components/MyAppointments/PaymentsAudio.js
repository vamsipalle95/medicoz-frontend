...
export default function PaymentAudio() {
            ...
            <div>
               <div className="container px-2 py-5">
                <div className="draCard2 ms-auto me-auto p-3">
                    ...
                    {/*doacTitle-ends-here*/}
                   <Link to="/HealthConcerns"><button type="button" className="btn spmBtn w-100 mt-4"><img src={Debit} alt="deibit" className="me-3" width="24px" height="24px" />Debit card</button></Link>
