...
export default function BookFollowUpVideo() {
  
        return (
            <div>
                 <div className="draCard3 m-2 p-3">
                        <div className="w-100 doacTitle d-flex align-items-center pb-2">
                            <img src={Camera} alt="todo" className="me-2" />
                            <h3 className="mb-0">Book Follow-up Video Appointment</h3>
                        </div>
                        {/*doacTitle-ends-here*/}
                                ...
                                <div className="w-100 doaTabs mt-3">
                                    ...
                                    <div className="tab-pane fade show active" id="morning" role="tabpanel" aria-labelledby="morning-tab">
                                        ...
                                        <div className="doaConfirm w-100 d-flex align-items-center mt-4">
                                            ...
                                            <Link to="/ConfirmVideoFollowup"><button type="button" className="btn doacBtn">Confirm</button></Link>
                                        </div>
