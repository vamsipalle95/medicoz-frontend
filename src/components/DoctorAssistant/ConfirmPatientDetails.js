        ...
        <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
          <div className="draCard2 p-3">
            ...
            <form className="w-100 mt-4">
              ...
              <div className="mpText w-100 mb-2 mx-2 border p-1">Sai</div>
              <div className="mpText w-100 mb-2">* Last Name</div>
              <div className="mpText w-100 mb-2 mx-2 border p-1">Rebba</div>
              ...
              <div className="mpText w-100 mb-2 mx-2 border p-1">36</div>
              <div className="mpText w-100 mt-3 mb-2">City/Dist</div>
              <div className="mpText w-100 mb-2 mx-2 border p-1">Hyderabad</div>
              ...
              <div className="mpText w-100 mt-3 mb-2">Pin Code</div>
              <div className="mpText w-100 mb-2 mx-2 border p-1">500072</div>
              <Link to="/ConfirmAppointment">
                <button
                  type="button"
                  className="d-block btn doaOrangeBtn clsuder mt-4 ms-auto"
                >
                  Confirm Patient Details
                </button>
              </Link>
