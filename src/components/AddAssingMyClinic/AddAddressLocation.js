...
export default function AddAddressLocation() {
  ...
  <div className="draCard2 p-3">
    <div className="w-100 doacTitle d-flex align-items-center pb-2">
      <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> Add/Edit Address</h3>
    </div>
    {/*doacTitle-ends-here*/}
    ...
    <form className="w-100 mt-4">
      ...
      <Link to="/AddClinicAddress"><button type="submit" className="d-block btn doacBtn px-4 mt-4 mx-auto">Save Address</button></Link>
    </form>
    {/*form-ends-here*/}
  </div>
  {/*draCard1-ends-here*/}
