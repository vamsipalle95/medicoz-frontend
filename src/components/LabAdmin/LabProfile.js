    ...
    <div>
      <div className="overflow-auto p-md-3  mb-4">
        <div className="w-100 d-flex flex-wrap align-items-baseline justify-content-between p-3 p-md-0">
          <div className="mb-2">
            <h1 className="mpTitle mb-0 me-3">Lab Name (Admin)</h1>
          </div>
        ...
        <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                ...
                <h3 className="mb-0">Lab Admin Info</h3>
              </div>
              {/*doacTitle-ends-here*/}
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                <h3 className="mb-0">Lab Profile Picture</h3>
              </div>
              {/*doacTitle-ends-here*/}
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              ...
              >
                ...
                <div className="mpText mt-1">Renevo Labs</div>
              </div>
              <div
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                <h3 className="mb-0">Affiliated Hospital/Clinic</h3>
              </div>
              {/*doacTitle-ends-here*/}
              <div className="w-100 mt-3 text-center">
                <img src={Clinic} className="me-2" />
              </div>
            </div>
          </div>
          {/*draCard2-ends-here*/}
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              ...
              <div className="w-100 d-flex align-items-center justify-content-center mt-4">
                <button
                  type="button"
                  className="btn doacBtn me-3"
                  onclick="location.href='lab-offers-view.html';"
                >
                  View
                </button>
                <button
                  ...
                  onclick="location.href='lab-add-offer.html';"
                >
                  +Add
                </button>
              </div>
          ...
          <div className="draCard2 p-3 m-2">
            <div style={{ height: 340 }}>
              <div className="w-100 doacTitle d-flex align-items-center pb-2">
                <img src={SocLinks} className="me-2" />
                <h3 className="mb-0">Home Sample Collections</h3>
              </div>
              {/*doacTitle-ends-here*/}
        ...
        >
          <div className="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content border-0">
              ...
              <div className="modal-body">
                <form className="w-100">
                  <div className="mpText w-100 mb-2">* Lab Name</div>
                  <input className="form-control w-100" type="text" required />
