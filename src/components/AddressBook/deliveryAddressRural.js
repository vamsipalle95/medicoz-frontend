  ...
  <div className="draCard2 p-3">
    ...
    <div className="w-100 irBtn mt-2">
      <div className="form-check form-check-inline">
        <Link to="/DeliveryAddressUrban"><input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" defaultValue="option1" defaultChecked /></Link>
        <label className="form-check-label" htmlFor="inlineRadio1">Urban</label>
      </div>
      <div className="form-check form-check-inline">
      <Link to="/DeliveryAddressRural"><input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" defaultValue="option2"  /></Link>
    ...
    <form className="w-100 mt-4">
      ...
      <input className="form-control w-100" type="text" required />
      <p className="mt-1 mb-0" style={{fontSize: 8, fontWeight: 500, color: '#323857'}}>This bill will be prepared against this name</p>
      <div className="mpText w-100 mt-3 mb-2">
        * Mobile Number
      </div>
      <input className="form-control w-100" type="text" placeholder={231123544222} required />
      <button type="submit" className="d-block btn doacBtn px-4 mt-4 mx-auto">Save Delivery Address</button>
    </form>
    {/*form-ends-here*/}
  </div>
  {/*draCard1-ends-here*/}
