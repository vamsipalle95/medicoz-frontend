...
function Localization() {
  return (
    <div>
      ...
      <div className="btn-group d-flex mb-3 justify-content-end malign-items-end">
        <button type="button" className="btn btn-orange text-white mx-1 bg2">
          + Add State
        </button>
        <button type="button" className="btn btn-orange text-white mx-1 bg2">
          + Add District
          ...
          <tbody>
            <tr>
              ...
              <td className="text-center">
                ...
                <i className="fa fa-trash cls-fa1"></i>
              </td>
            </tr>
            <tr>
              <td>1.</td>
