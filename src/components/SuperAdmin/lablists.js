    ...
    <div>
      <div className="row mb-2">
        <div className="col-sm-6 pl-25">
          <h5
            className="m-0 font-weight-bold fnt-clr fs-700 p-3"
            type="button"
            data-bs-toggle="modal"
            data-bs-target="#addLab"
          >
            Diagnostic Labs List
          </h5>
        </div>
        {/* /.col */}
            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewLab"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editLab"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteLab"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Lab Name</div>
                  <input
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Lab Admin Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Lab Admin Name"
                  />
                </div>
                <div className="col-6">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Lab Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Show as Top Lab</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Labs Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Labs Name"
                    value="Dr.Raghava"
                  />
                </div>
                <div className="col-6">
