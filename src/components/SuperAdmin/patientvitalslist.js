...
function PatientVitalsListComponent() {
  return (
    <div>
            ...
            <tr>
              ...
              <td className="text-center">
                ...
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editPV"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deletePV"
                ></i>
              </td>
            </tr>
            <tr>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div class="doaNText w-100 mt-3">Patient Vitals Name</div>
              <input
                class="form-control w-100 mt-2"
                type="text"
                placeholder="Patient Vitals Name"
              />
            </div>
            {/*modal-body-ends-here*/}
...
export default PatientVitalsListComponent;
