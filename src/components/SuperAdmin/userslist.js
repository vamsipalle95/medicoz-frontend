            ...
            <tr>
              ...
              <td>
                <select className="form-select">
                  ...
                  <option value={5}>Mandal/Taluk</option>
                  <option value={6}>City/Town Admin</option>
                  <option value={7}>Locality/Area Admin</option>
                  <option value={8}>City-Zone Admin</option>
                  <option value={8}>Locality under City-Zone Admin</option>
                </select>
              </td>
