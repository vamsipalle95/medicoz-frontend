            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewLHSC"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editLHSC"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteLHSC"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Staff Name</div>
                  <input
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Staff ID</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Lab ID</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="Lab ID"
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                View Lab Home Sample Collection Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                Edit Lab Home Sample Collection Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-footer border-0">
              <button type="button" className="btn fmaBtn">
                Edit Lab Home Sample Collection Staff
              </button>
            </div>
            {/*modal-footer-ends-here*/}
          </div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            <div className="modal-header">
              <h5 className="modal-title" id="filterModalLabel">
                Delete Lab Home Sample Collection Staff List
              </h5>
              <button
                type="button"
                className="btn-close"
...
export default labHomeSampleCollection;
