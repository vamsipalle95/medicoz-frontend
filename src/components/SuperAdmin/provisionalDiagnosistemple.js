        ...
        <div className="col-sm-5">
          <div className="alig_btns">
            <div className="add_btn px-2">
              ...
              >
                + Add Provisional Diagnosis Bulk Upload Template
              </button>
            </div>
        ...
        <div className="templatecls">
          <div className="w-100 overflow-auto mt-3">
            <table className="mb-3" id="table_id">
              ...
              <tbody>
                <tr>
                  <td>Provisional Diagnosis Bulk Upload Template</td>
                  <td>
...
export default ProvisionalDiagnsisBulkUpload;
