      ...
      <div className="w-100 overflow-auto mt-3">
        <table className="mb-3 w-100" id="table_id">
          ...
          <tbody>
            <tr>
              <td>1.</td>
              <td>Telangana State Medical Council</td>
            ...
            <tr>
              <td>2.</td>
              <td>AP State Medical Council</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
                <i className="fa fa-trash cls_fa1"></i>
            ...
            <tr>
              <td>3.</td>
              <td>Karnataka State Medical Council</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
                <i className="fa fa-trash cls_fa1"></i>
            ...
            <tr>
              <td>4.</td>
              <td>Tamilnadu State Medical Council</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
                <i className="fa fa-trash cls_fa1"></i>
            ...
            <tr>
              <td>4.</td>
              <td>Kerala State Medical Council</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
                <i className="fa fa-trash cls_fa1"></i>
...
export default StateMedicalcouncilList;
