...
function PatientVitalsBulkUpload() {
  return (
    <div>
      <div className="row mb-2">
        <div className="col-sm-8 pl-25">
          <h5 className="m-0 font-weight-bold fnt-clr fs-700 p-3">
            Patient Vitals-Bulk Upload Template
          </h5>
        </div>
        {/* /.col */}
        ...
        <div className="templatecls">
          <div className="w-100 overflow-auto mt-3">
            <table className="mb-3" id="table_id">
              ...
              <tbody>
                <tr>
                  <td>Patient-Bulk Upload Template</td>
                  <td>
...
export default PatientVitalsBulkUpload;
