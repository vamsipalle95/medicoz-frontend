        ...
        <div className="col-sm-6">
          <div className="alig_btns">
            <div className="add_btn px-2">
              <button className="btn btn-orange mr-2 mright bg2">
                + Add Conveyance Charge
              </button>
            </div>
      ...
      <div className="w-100 overflow-auto mt-3">
        <table className="mb-3 w-100" id="table_id">
          ...
          <tbody>
            <tr>
              <td>1.</td>
              <td>Video Consultation Conveyance Charges</td>
              <td>₹ 50.00</td>
            ...
            <tr>
              <td>1.</td>
              <td>Audio Consultation Conveyance Charges</td>
              <td>₹ 30.00</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
            ...
            <tr>
              <td>1.</td>
              <td>Booking Conveyance Charges</td>
              <td>₹ 30.00</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
            ...
            <tr>
              <td>1.</td>
              <td>Medicines Booking Conveyance Charges</td>
              <td>₹ 30.00</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
            ...
            <tr>
              <td>1.</td>
              <td>Lab Tests Booking Conveyance Charges</td>
              <td>₹ 40.00</td>
              <td className="text-center">
                <i className="fa fa-eye cls_fa"></i>
                <i className="fa fa-edit cls_fa"></i>
...
export default ConveyanceChargesList;
