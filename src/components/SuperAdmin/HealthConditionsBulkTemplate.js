        ...
        <div className="templatecls">
          <div className="w-100 overflow-auto mt-3">
            <table className="mb-3" id="table_id">
              ...
              <tbody>
                <tr>
                  <td>Health Conditions Bulk Upload Template</td>
                  <td>
...
export default HealthConditionsBulkTemplate;
