        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Hospital Name</div>
                  <input
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Hospital Admin Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Hospital Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Show as Top Hospital</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
