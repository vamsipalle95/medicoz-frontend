          ...
          <div className="alig_btns">
            <div className="add_btn px-2">
              <button
                ...
                data-bs-target="#addInvestigation"
              >
                + Add Investigation Name
              </button>
            </div>
      ...
      <div className="w-100 overflow-auto mt-3">
        <table className="mb-3 w-100" id="table_id">
          ...
          <tbody>
            <tr>
              <td>1.</td>
              <td>CBP-Complete Blood Picture</td>
              <td className="text-center">
                <i
                  className="fa fa-eye cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewInvestigation"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editInvestigation"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteInvestigation"
                ></i>
              </td>
            </tr>
            <tr>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div class="doaNText w-100 mt-3">Investigation Name</div>
              <input
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div class="doaNText w-100 mt-3">Investigation Name</div>
              <div>CBP-Complete Blood Picture</div>
            </div>
            {/*modal-body-ends-here*/}
            <div className="modal-footer border-0">
              <button type="button" className="btn fmaBtn">
          ...
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              ...
              <input
                ...
                type="text"
                placeholder="Investigation  Name"
                value="CBP-Complete Blood Picture"
              />
            </div>
            {/*modal-body-ends-here*/}
            <div className="modal-footer border-0">
