      ...
      <div className="w-100 overflow-auto mt-3">
        <table className="mb-3 w-100" id="table_id">
          <thead>
            <tr>
              <th>S.No.</th>
              <th>Health Concern - Vital Name</th>
...
export default HealthConcernVitalLists;
