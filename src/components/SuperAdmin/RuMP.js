        ...
        <table className="overflow_tb2 mb-3" id="table_id">
          <thead>
            <tr>
              ...
              <th>Start Date</th>
              <th>Due Date</th>
              <th>Enable Level-1 Package</th>

              <th>Enable Clinic Package</th>
              <th>Enable as Remote Partner</th>
              <th>Show as Top Dr</th>
            ...
            <tr>
              ...
              <td className="text-center">
                <i
                  ...
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#viewRump"
                ></i>
                <i
                  className="fa fa-edit cls_fa"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#editRump"
                ></i>
                <i
                  className="fa fa-trash cls_fa1"
                  type="button"
                  data-bs-toggle="modal"
                  data-bs-target="#deleteRump"
                ></i>
              </td>
            </tr>
            <tr>
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">RuMP Name</div>
                  <input
                    class="form-control w-100 mt-2"
                    type="text"
                    placeholder="RuMP Name"
                  />
                </div>
                <div className="col-6">
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Enable Level-1 Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Enable Clinic Package</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div class="doaNText w-100 mt-3">Show as Top RuMP</div>
                  <div class="form-check form-switch mt-3">
                    <input class="form-check-input switchcls" type="checkbox" />
                  </div>
                </div>
