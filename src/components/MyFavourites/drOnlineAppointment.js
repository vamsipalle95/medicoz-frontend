...
class drOnlineAppointment extends Component {
    render() {
        return (
            <div>
  ...
  <div className="draCard2 ms-auto me-auto p-3">
    ...
    <form className="w-100 mt-3">
      ...
      <div className="doaConfirm w-100 d-flex align-items-center mt-4">
        <Link to="/MyFavourites"><button type="button" className="btn doabBtn ms-auto me-3 px-4">Back</button></Link>
        <Link to="/Newuser"><button type="submit" className="btn doacBtn px-4">Next</button></Link>
      </div>
...
export default drOnlineAppointment;