...
import RuMpDashboard from "../RuMPRemotePartner/RuMpDashboard";
import RuMpMyProfile from "../RuMPRemotePartner/RuMpMyProfile";
import RuMPMyAppointmentCalendar from "../RuMPRemotePartner/RuMPMyAppointmentCalendar";
import RuMPPatientManagement from "../RuMPRemotePartner/RuMPPatientManagement";
import RuMPAssignmentClinic from "../RuMPRemotePartner/RuMPAssignmentClinic";
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-xs-12 col-sm-12">
              <div className="sdrText1 m-2 patchBg d-flex flex-wrap justify-content-start align-items-center">
                RuMP (Rural Medical Practioner) - ADMIN PANEL
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-xs-12 col-sm-12 col100">
              <div className="myPhoneCardCnt overflow-auto p-md-3 my-4">
                <Switch>
                  <Route exact path="/RuMpDashboard">
                    <RuMpDashboard />
                  </Route>
                  ...
                  <Route exact path="/RuMpMyProfile">
                    <RuMpMyProfile />
                  </Route>
                  ...
                  <Route exact path="/RuMPMyAppointmentCalendar">
                    <RuMPMyAppointmentCalendar />
                  </Route>

                  <Route exact path="/RuMPPatientManagement">
                    <RuMPPatientManagement />
                  </Route>
                  ...
                  <Route exact path="/RuMPAssignmentClinic">
                    <RuMPAssignmentClinic />
                  </Route>
