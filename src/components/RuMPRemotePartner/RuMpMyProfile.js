...
class rumpmyprofile extends Component {
  render() {
    return (
      <div>
        <div className="overflow-auto p-md-3 mb-4">
          ...
          <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
            ...
            <div className="draCard1 p-3 m-2">
              <div style={{ height: 340 }}>
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  ...
                  <h3 className="mb-0">RuMP Registration</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <div className="w-100 mt-3">
            ...
            <div className="draCard1 p-3 m-2">
              <div style={{ height: 340 }}>
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  ...
                  <h3 className="mb-0">Home Address</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <div className="w-100 mt-3">
                  <img src={Map} alt="map" />
            ...
            <div className="draCard1 p-3 m-2">
              <div style={{ height: 340 }}>
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  <img src={Bank} alt="bank" className="me-2" />
                  <h3 className="mb-0">Bank Details</h3>
                </div>
                {/*doacTitle-ends-here*/}
                <div className="w-100 mt-3">
                  <p className="mpText mb-0">
                    To transfer your consultations fees
                  </p>
                </div>
              ...
              <div className="w-100 text-center mt-3">
                <Link to="/AddBankaccount">
                  <button
                    type="button"
                    className="btn doaOrangeBtn px-3 py-2"
                    onclick="location.href='dr-add-edit-bank-details.html';"
                  >
                    Add/Edit
                  </button>
                </Link>
            ...
            <div className="draCard1 p-3 m-2">
              <div style={{ height: 340 }}>
                <div className="w-100 doacTitle d-flex align-items-center pb-2">
                  <img src={LockOpen} alt="openlock" className="me-2" />
