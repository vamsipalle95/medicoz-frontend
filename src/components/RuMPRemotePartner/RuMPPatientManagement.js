...
export default function RuMpPatientManagement() {
  return (
    <div>
      <div className="overflow-auto p-md-3 mb-4">
        <div className="w-100 p-3 mt-3 mpGrayBox">
          <div className="mpTitle me-3 mb-3 mb-sm-0">My Patient Management</div>
          {/*doaNText-ends-here*/}
        </div>
        {/*flexbox-ends-here*/}
        <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
          <div className="drHospitalCard m-2 p-3">
            <div className="w-100 doacTitle mb-3 pb-2">
              <h3 className="mb-0">
                <img src={PatientList} alt="patientlist" className="me-2" />
                My Patients list
              </h3>
            </div>
            {/*doacTitle-ends-here*/}
            ...
            <div className="w-100 d-flex align-items-center justify-content-between mt-4">
              <Link to="/PatientList">
                ...
                <button
                  ...
                  onclick="location.href='dr-patient-list.html';"
                >
                  View
                </button>
              </Link>
          ...
          <div className="drHospitalCard m-2 p-3">
            <div className="w-100 doacTitle mb-3 pb-2">
              <h3 className="mb-0">
                <img src={Rpl} alt="rpl" className="me-2" /> Follow-up Patients
                List
              </h3>
            </div>
            {/*doacTitle-ends-here*/}
          ...
          <div className="drHospitalCard m-2 p-3">
            <div className="w-100 doacTitle mb-3 pb-2">
              <h3 className="mb-0">
                <img src={PatientList} alt="patientlist" className="me-2" />
                Patients Ref - <span className="clrOrg">BY Me</span>
              </h3>
            </div>
            {/*doacTitle-ends-here*/}
            <Link to="/PatientReferredList">
              <div className="walletCircle d-flex flex-wrap align-content-center text-center mt-4 mx-auto">
