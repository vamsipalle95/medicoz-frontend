      ...
      <div className="overflow-auto p-md-3 ms-lg-3 mb-4">
        <div className="draCard2 p-3">
          <div className="w-100 doacTitle d-flex align-items-center pb-2">
            <h3 className="mb-0">
              <img src={Back} alt="backbtn" onClick={() => history.goBack()} />
              Add / Edit Doctor
            </h3>
          </div>
          {/*doacTitle-ends-here*/}
          <form className="w-100 mt-3">
            ...
            <input className="form-control w-100" type="text" required />
            <div className="mpText w-100 mt-3 mb-2">* Speciality</div>
            <input className="form-control w-100" type="text" required />
...
export default PharmaDrAddEdit;
