...
export default function FeeDetailsNonClinic() {
            ...
            <div>
                ...
                <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
                    ...
                    <div className="w-100 doacTitle d-flex align-items-center pb-2">
                        <h3 className="mb-0"><img src={Backbtn} alt="back" onClick={() => history.goBack()} /> Fee Details for Non-Clinic Dr.</h3>
                    </div>
                    {/*doacTitle-ends-here*/}
                    <form className="w-100 mt-4">
                        <div className="mpText w-100 mb-2">
                        * <span style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>₹</span> For Audio Consultation
                        </div>
                        <input className="form-control w-100" type="text" required />
                        <div className="mpText w-100 mt-3 mb-2">
                        * <span style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>₹</span> For Video Consultation
                        </div>
                        <input className="form-control w-100" type="text" required />
