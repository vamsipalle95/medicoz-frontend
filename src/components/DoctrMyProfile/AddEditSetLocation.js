...
import SearchGreen from '../../images/doctoModule/search-green.png';
import Gps from '../../images/doctoModule/gps.png';
import Backbtn from '../../images/back-button-new.png'; 
import {useHistory} from 'react-router-dom';
import {BrowserRouter as Router, Switch, Route, Link } from "react-router-dom";

export default function AddEditSetLocation() {
  ...
  <div className="w-100 d-flex flex-wrap justify-content-center justify-content-md-start align-items-flex-start mt-3">
    <div className="draCard2 p-3">
      <div className="w-100 doacTitle d-flex align-items-center pb-2">
        <h3 className="mb-0"><img onClick={() => history.goBack()} alt="back" src={Backbtn} /> Set Location</h3>
      </div>
      {/*doacTitle-ends-here*/}
      <div className="input-group w-100 mt-4">
       
      </div>
      <Link to="/AddressSetLocation" className="text-decoration-none w-100 d-flex align-items-center my-4">
        <div className="me-2">
          <img src={Gps} alt='gps' />
        </div>
        <div>
